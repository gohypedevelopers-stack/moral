...
const products: Product[] = [
  {
    name: "Blvck x UFC Candle",
    price: "Rs. 21,726.07",
    imageSrc: "/products/image1.webp",
    imageAlt: "Black BLVCK x UFC candle",
  },
  {
    name: "Blvck x UFC Acid Wash Hoodie",
    price: "Rs. 19,750.97",
    imageSrc: "/products/image2.webp",
    imageAlt: "Black BLVCK x UFC acid wash hoodie",
  },
  {
    name: "Blvck x Acid Wash Tee",
    price: "Rs. 15,800.78",
    imageSrc: "/products/image3.webp",
    imageAlt: "Black BLVCK x acid wash tee",
  },
  {
    name: "Blvck x UFC 'Glory' Hoodie",
    price: "Rs. 13,825.68",
    imageSrc: "/products/image4.webp",
    imageAlt: "Black BLVCK x UFC Glory hoodie",
  },
  {
    name: "Blvck Signature Mohair Cardigan",
    price: "Rs. 5,925.29",
    imageSrc: "/products/image5.jpg",
    imageAlt: "Black BLVCK signature mohair cardigan",
  },
  {
    name: "Blvck x UFC Water Bottle",
    price: "Rs. 5,925.29",
    imageSrc: "/products/image6.webp",
    imageAlt: "Black BLVCK x UFC water bottle",
  },
  {
    name: "Blvck x UFC 'Glove' Tee",
    price: "Rs. 5,925.29",
    imageSrc: "/products/image7.webp",
    imageAlt: "Black BLVCK x UFC glove tee",
  },
  {
    name: "Blvck x UFC Keychain",
    price: "Rs. 6,285.00",
    imageSrc: "/products/image8.webp",
    imageAlt: "Black BLVCK x UFC keychain",
  },
  {
    name: "Blvck Wool Jacket",
    price: "Rs. 7,840.00",
    imageSrc: "/products/image9.webp",
    imageAlt: "Black BLVCK wool jacket",
  },
  {
    name: "Blvck Wool Trouser",
    price: "Rs. 18,420.00",
    imageSrc: "/products/image10.jpg",
    imageAlt: "Black BLVCK wool trouser",
  },
  {
    name: "Blvck Tank Top with Built in Bra",
    price: "Rs. 19,260.00",
    imageSrc: "/products/image11.webp",
    imageAlt: "Black BLVCK tank top with built-in bra",
  },
  {
    name: "Blvck Tee with Built In Bra",
    price: "Rs. 19,260.00",
    imageSrc: "/products/image12.webp",
    imageAlt: "Black BLVCK tee with built-in bra",
  },
]
